...
class TextToSqlEngine(BaseEngine):
    ...
    def initialize(self):
        ...
        Returns:
            model:
                The output of GPT2LMHeadModel.from_pretrained("rakeshkiriyath/gpt2Medium_text_to_sql")
            tokenizer:
                The output of GPT2Tokenizer.from_pretrained("rakeshkiriyath/gpt2Medium_text_to_sql")
    ...
    def execute(self, model, tokenizer):
        ...
        Arguments:
            model:
                The GPT2LMHeadModel generated/outputted from self.initialize()
                (GPT2LMHeadModel.from_pretrained("rakeshkiriyath/gpt2Medium_text_to_sql"))
            tokenizer:
                The GPT2Tokenizer generated/outputted from self.initialize()
                (GPT2Tokenizer.from_pretrained("rakeshkiriyath/gpt2Medium_text_to_sql"))
